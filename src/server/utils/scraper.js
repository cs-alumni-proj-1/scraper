...
const url = 'https://www.centralbank.go.ke/policy-procedures/legislation-and-guidelines/circulars';
...
const scrapeWebsite = async () => {
  try {
    ...
    const latestCircular = $('div.view-content div.views-row:first-child h3 a').text();
